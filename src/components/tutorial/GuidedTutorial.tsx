            ...
            <CardContent className="p-4 sm:p-6 lg:p-8">
              <div className="grid lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                ...
                <div className="lg:col-span-1">
                  <div className="bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-800 dark:to-blue-900/20 rounded-xl p-4 sm:p-6 shadow-lg">
                    ...
                    <div className="space-y-2 sm:space-y-3 mb-6 sm:mb-8 max-h-64 sm:max-h-80 overflow-y-auto">

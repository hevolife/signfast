    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-500 overflow-y-auto">
      <div className="w-full max-w-sm sm:max-w-md mx-auto my-4">
        ...
        <CardContent className="p-3 sm:p-4 space-y-3 sm:space-y-4">
          ...
          {/* Conseils et astuces */}
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-3 sm:p-4 rounded-lg border border-blue-200 dark:border-blue-800 shadow-inner animate-in slide-in-from-bottom duration-700 delay-2000">
            <div className="flex items-center space-x-2 mb-3">
              <div className="w-4 h-4 sm:w-5 sm:h-5 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg">
                <Gift className="h-2 w-2 sm:h-4 sm:w-4 text-white" />
              </div>
          ...
          <div className="flex flex-col gap-2 sm:gap-3 animate-in slide-in-from-bottom duration-700 delay-2500">
            ...
            <Button
              variant="ghost"
              onClick={handleEndDemo}
              className="w-full bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 font-semibold py-2 shadow-lg hover:shadow-xl transition-all duration-300"
            >
              <span className="text-xs sm:text-sm">Quitter la démo</span>
            </Button>
          </div>

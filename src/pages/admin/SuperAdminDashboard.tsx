...
export const SuperAdminDashboard: React.FC = () => {
  ...
  const loadUsers = async () => {
    try {
      setLoading(true);
      // Créer des données de test directement (évite les problèmes de permissions)
      ...
      const demoUsers: UserData[] = [
        ...
        {
          id: 'demo-user-1',
          email: 'marie.martin@consulting-digital.fr',
        ...
        {
          id: 'demo-user-2',
          email: 'jean.dupont@immobilier-dupont.com',
        ...
        {
          id: 'demo-user-3',
          email: 'sophie.bernard@freelance-design.fr',
        ...
        {
          id: 'demo-user-4',
          email: 'thomas.leroy@startup-tech.com',
        ...
        {
          id: 'demo-user-5',
          email: 'contact@cabinet-avocat.fr',
          ...
          profile: {
            first_name: 'Maître',
            last_name: 'Dubois',
            company_name: 'Cabinet d\'Avocats Dubois'
          },
          subscription: {
            status: 'active',
            price_id: 'price_1S6HwBKiNbWQJGP35byRSSBn',
      ...
      setUsers(demoUsers);
      console.log('✅ Données de démonstration chargées:', demoUsers.length, 'utilisateurs');
    } catch (error) {

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-indigo-900/20 dark:to-purple-900/20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Onglets */}
        <div className="mb-8 bg-white/60 backdrop-blur-sm rounded-2xl p-0 shadow-xl">
          <div>
            <nav className="flex justify-center flex-wrap">
              <button
                onClick={() => setActiveTab('profile')}
                className={`py-3 px-4 font-bold text-sm transition-all active:scale-95 hover:scale-105 first:rounded-l-2xl last:rounded-r-2xl ${getTabColorClasses('profile', activeTab === 'profile')}`}
              >
              ...
              <button
                ...
                className={`py-3 px-4 font-bold text-sm transition-all active:scale-95 hover:scale-105 first:rounded-l-2xl last:rounded-r-2xl ${getTabColorClasses('security', activeTab === 'security')}`}
              >
                <div className="flex items-center space-x-2">
                  <div className="p-1 rounded-lg">
              ...
              <button
                ...
                className={`py-3 px-4 font-bold text-sm transition-all active:scale-95 hover:scale-105 first:rounded-l-2xl last:rounded-r-2xl ${getTabColorClasses('affiliate', activeTab === 'affiliate')}`}
              >
                <div className="flex items-center space-x-2">
                  <div className="p-1 rounded-lg">
              ...
              <button
                ...
                className={`py-3 px-4 font-bold text-sm transition-all active:scale-95 hover:scale-105 first:rounded-l-2xl last:rounded-r-2xl ${getTabColorClasses('subscription', activeTab === 'subscription')}`}
              >
                <div className="flex items-center space-x-2">
                  <div className="p-1 rounded-lg">
              ...
              <button
                ...
                className="py-3 px-4 font-bold text-sm transition-all active:scale-95 hover:scale-105 text-gray-600 dark:text-gray-400 hover:bg-gradient-to-br hover:from-gray-100 hover:to-slate-200 hover:text-gray-700 hover:shadow-lg first:rounded-l-2xl last:rounded-r-2xl"
